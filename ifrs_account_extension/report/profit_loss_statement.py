...
report_sxw.report_sxw('report.profit.loss.statement', 'account.account', 'addons_aug/ifrs_account/report/statement_profit_loss.rml', parser=profit_loss_statement)

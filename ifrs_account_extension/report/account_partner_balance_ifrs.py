...
report_sxw.report_sxw('report.account.partner.balance1', 'res.partner', 'ifrs_account_extension/report/account_partner_balance.rml',parser=partner_balance, header="internal")

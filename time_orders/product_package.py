...
class product_packages_line(osv.osv):
    ...
    _columns = {
        ...
        'line_id10': fields.many2one('product.template', 'Line'),
        'line_id11': fields.many2one('product.template', 'Line'),
        'line_id12': fields.many2one('product.template', 'Line'),
        'line_id13': fields.many2one('product.template', 'Line'),                        
        'line_id14': fields.many2one('product.template', 'Line'),
        'line_id15': fields.many2one('product.template', 'Line'),
        'line_id16': fields.many2one('product.template', 'Line'),
        'line_id17': fields.many2one('product.template', 'Line'),

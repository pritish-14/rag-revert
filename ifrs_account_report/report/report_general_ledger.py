...
class account_report_general_ledger(osv.osv_memory):
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        if data['form']['landscape']:
            return { 'type': 'ir.actions.report.xml', 'report_name': 'account.general.ledger_landscape1', 'datas': data}
...
report_sxw.report_sxw('report.account.account.balance1', 'account.account', 'addons_aug/ifrs_account/report/account_balance1.rml', parser=account_balance1, header="internal")
...
report_sxw.report_sxw('report.account.general.ledger1', 'account.account', 'addons_aug/ifrs_account/report/general_ledger.rml', parser=account_general_ledger, header='internal')
report_sxw.report_sxw('report.account.general.ledger_landscape1', 'account.account', 'addons_aug/ifrs_account/report/general_ledger.rml', parser=account_general_ledger, header='internal landscape')